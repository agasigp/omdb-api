...
test('it returns list of movies based on IMDB params', function () {
    $responseData = [
        "Search" => [
            [
...
test('it can stores movie in cache', function () {
    $responseData = [
        "Title" => "Furiosa: A Mad Max Saga",
        "Year" => "2024",
        "Rated" => "R",
    ...
    Cache::shouldHaveReceived('remember')
        ->once()
        ->with('movie', 60, Closure::class);
});

test('it can stores list of movies based on IMDB params', function () {
    $responseData = [
        "Search" => [
            [
                "Title" => "The Karate Kid",
